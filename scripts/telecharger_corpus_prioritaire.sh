...
echo "── CRITIQUE ──"
echo "  Note : eur-lex.europa.eu répond 202 (WAF AWS, corps vide) à tout client"
echo "  non-navigateur depuis le 2026-09-21. Pour un téléchargement par script,"
echo "  utiliser publications.europa.eu/resource/celex/<CELEX> (PDF, sans WAF)."
echo ""
...
echo ""
echo "  REACH           → https://publications.europa.eu/resource/celex/32006R1907"
echo "                    PDF officiel (CELLAR), téléchargeable sans navigateur :"
echo "                    curl -L -o data/raw/reach_2006_1907.pdf \\"
echo "                      https://publications.europa.eu/resource/celex/32006R1907"
echo "                    Puis : python scripts/pdf_to_json.py --fichier"
echo "                      data/raw/reach_2006_1907.pdf --id REACH_1907_2006 \\"
echo "                      --titre \"Règlement (CE) 1907/2006 — REACH\" --source EUR-Lex \\"
echo "                      --publication 2006-12-18 --vigueur 2007-06-01 \\"
echo "                      --themes environnement,substances_chimiques"
echo ""
